  ...
  <div class="page-header d-print-none">
    <div class="container-xl">
      <div class="row g-2 align-items-center">
        <div class="col">
          <h2 class="page-title !text-red-500">
            Quiz
          </h2>
        </div>
      </div>
          ...
          $("#dataTable").DataTable({
            ...
            "columns": [{
              ...
              "render": function(data, type, row) {
                return '<button type="button" class="btn btn-link" data-bs-toggle="modal" data-bs-target="#modalGambar" onclick="setImage(\'/storage/uploads/quiz/' +
                  data + '\')">' +
