                      ...
                      <form action="{{ route('absen.cetakrekap') }}" method="POST" target="_blank">
                        ...
                        <div class="row">
                          <div class="col-4 mt-2">
                            <div class="form-group">
                              <button class="btn btn-primary w-100" name="preview" id="preview"><svg xmlns="http://www.w3.org/2000/svg"
                                  class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5"
                          ...
                          <div class="col-4 mt-2">
                            <div class="form-group">
                              <button type="submit" class="btn btn-primary w-100" name="cetak"><svg xmlns="http://www.w3.org/2000/svg"
                                  class="icon icon-tabler icon-tabler-printer" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                  stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                          ...
                          <div class="col-4 mt-2">
                            <div class="form-group">
                              <button type="submit" class="btn btn-success w-100" name="exportExcel"><svg xmlns="http://www.w3.org/2000/svg"
                                  class="icon icon-tabler icon-tabler-download" width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
                                  stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                  <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            ...
                            <table class="table table-bordered" id="dataTable">
                              <thead>
                                <tr>
                                  ...
                                  <th class="text-center tanggal" id="ThTanggal">Tanggal</th>
                                  <th rowspan="3">TM</th>
                                  <th rowspan="3">TK</th>
                                  <th rowspan="3">TI</th>
                                  <th rowspan="3">TS</th>
      ...
      $('#preview').on('click', function(e) {
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            // Append date headers
            for (let i = 26; i <= totalDays; i++) {
              let date = new Date(tahun, bulan - 2, i);
              ...
              dateHeadersRow.append(
                `<th colspan="3" class="text-center">${formattedDate}</th>`
              );
            ...
            for (let i = 1; i <= 25; i++) {
              let date = new Date(tahun, bulan - 1, i);
              let formattedDate = date.toLocaleDateString('id-ID', {
                day: '2-digit',
                month: 'long',
                year: 'numeric'
            ...
            $.each(data, function(index, employee) {
              ...
              let totalsakit = 0;
              let totalalpha = 0;
              let total_hours_month = 0;
              let total_minutes_month = 0;
              ...
              for (let i = 26; i <= totalDays; i++) {
                ...
                if (tanggal === "LIBUR") {
                  total_time = 'LIBUR';
                } else if (employee[thour] !== null && employee[thour] > 0) {
                  total_time = employee[thour] + " Jam " + employee[tmin] + " Menit";
                  total_hours_month += parseInt(employee[thour]);
                  total_minutes_month += parseInt(employee[tmin]);
                } else {
                  total_time = '-';
                }
              ...
              let additional_hours = Math.floor(total_minutes_month / 60);
              let remaining_minutes = total_minutes_month % 60;
              total_hours_month += additional_hours;
            ...
            <td>${totalalpha}</td>
            <td>${totalhadir}</td>
            <td>${total_hours_month} Jam ${remaining_minutes} Menit</td>
